...
In mixture models, multiple model fit statistics can be used to compare models [@wang_structural_2020]. Information criterion indices, such as AIC, consistent AIC, BIC, aBIC, Lo-Mendell-Rubin likelihood ratio (LMR LR) test, adjusted LMR LR test and bootstrap likelihood ratio test (BLRT) are described in the following section.
